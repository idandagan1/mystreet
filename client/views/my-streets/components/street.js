...
export default function Street(props) {
    ...
    const { onChangePrimaryStreet, onLeaveStreetClick, streetName, i, onStreetClick, isPrimary } = props;
                ...
                <ul className='dropdown-menu' aria-labelledby='dropdownMenuLink'>
                    <li>
                        <span
                            ...
                            onClick={onChangePrimaryStreet}
                        >Set as primary street</span></li>
                    <li>
                        <span
                            className='n-mystreet-street-item'
                            onClick={onLeaveStreetClick}
                        >Leave street</span></li>
                </ul>
            </div>
        </li>
    );
...
Street.propTypes = {
    ...
    onLeaveStreetClick: PropTypes.func.isRequired,
}
